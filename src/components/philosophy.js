...
export function createPhilosophy() {
  ...
  const valuesHTML = philosophyData.values.map((v, i) => `
    <div class="philosophy__stat reveal" style="transition-delay: ${0.1 + i * 0.1}s">
  ...
  section.innerHTML = `
    ...
    <div class="philosophy__body">
      <div class="philosophy__body-inner">
        <div class="philosophy__image-col reveal-left">
        ...
        <div class="philosophy__text-col">
          ...
          <p class="philosophy__text reveal" style="transition-delay: 0.1s">
